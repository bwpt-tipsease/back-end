  ...
  return knex('serviceWorkers').truncate()
    .then(function () {
      ...
      return knex('serviceWorkers').insert([
        ...
        {worker_name: 'Martine Hurst', description: "Attendent at Princes Nail", start_date: '1999-0019-25', tagline: 'Attendant - There is No Substitute.',photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm5VOEra1f2mtwRQn-B9GNfiCHMw8CneUXigZ0f9phgR4wW17e"},
